                        ...
                        <div width='1169px'>
                            <table width="1170px" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                                <tr>
                                    ...
                                    <th width="100px" height="20" bgcolor="d3eaef">日志数量</th>
                                    <th width="300px" height="20" bgcolor="d3eaef">类别描述</th>
                                    <th width="200px" height="20" bgcolor="d3eaef">管理操作</th>
                                </tr>
                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr border="0" cellpadding="0" cellspacing="1" align="center" bgcolor="#FFFFFF">
                                        <td id='daily_type_id'><?php echo ($v['id']); ?></td>
                                        <td><?php echo ($v['type_name']); ?></td>
                                        <td><?php echo (date('Y-m-d',$v['c_time'])); ?></td>
                                        <td><?php echo ($v['daily_num']); ?></td>
                                        <td><?php echo ($v['type_descript']); ?></td>
                                        <td><a href="<?php echo U('Daily/update_daily_type',array('typeId'=>$v['id']),'',0);?>">修改</a>|<a href="<?php echo U('Daily/delete_daily_type',array('typeId'=>$v['id']),'',0);?>">删除</a></td>
