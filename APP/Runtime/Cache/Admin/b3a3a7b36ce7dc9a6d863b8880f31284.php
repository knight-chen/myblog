  ...
  <ul id="navigation">
    ...
    -->
        ...
        <td>
            ...
            <div class="right">
                <ul class="photo_init">
                    <?php if(is_array($photoList)): foreach($photoList as $k=>$v): ?><li>
                        <a href="javascript:void(0);" class="album_option"></a>
                        <a href="" class="photo_show" title="<?php echo ($v['name']); ?>"><img src="<?php echo ($v['photo_path']); ?>"/></a>

                        <a href="javascript:void(0);" data-path="<?php echo ($v['photo_path']); ?>" data-url="<?php echo U('Photo/set_cover','','',0);?>" data-albumId="<?php echo ($v['album_id']); ?>" class="set_cover">设为封面</a>
                        <a href="javascript:void(0);"  class="delete_photo" data-url="<?php echo U('Photo/delete_photo','','',0);?>" data-id="<?php echo ($v['id']); ?>" title="刪除">刪除</a>
