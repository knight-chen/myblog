      ...
      <ul>
        ...
        <td>
            ...
            <div class="center_right">
                <li style="margin-top:10px;"><span style="font-size:14px; margin-left: 38px; width: 1100px" >发布日期:<?php echo (date('Y-m-d',$draftInfo['c_time'])); ?></span><span class="span">类别:<?php echo ($draftInfo['type_name']); ?></span><span class="span">权限:<?php echo ($draftInfo['permission']); ?></span><span class="span_a"><a href="<?php echo U('Daily/update_draft',array('draftId'=>$draftInfo['id']));?>"> 修改</a></span><span style=" margin-left: 20px;"><a href="javascript:void(0);" onclick="delete_draft(<?php echo ($draftInfo['id']); ?>)">删除</a></span><span><a href="<?php echo U('Daily/put_draft',array('id'=>$draftInfo['id']),'',0);?>" style=" margin-left:20px;">发布</a></span></li>
                <ul class="ul">
                    <!--<li><input class="draft_title" type="text" readonly="treu" value="<?php echo ($draftInfo['name']); ?>"/></li>-->
                    <li><input id='draft_con' type='hidden' value="<?php echo ($draftInfo['content']); ?>"/></li>
...
//     var content="<?php echo $draftInfo['content'];?>";
    $('#draft_content').html('<li><input class="draft_title" type="text" readonly="treu" value="<?php echo ($draftInfo['name']); ?>"/></li>');
