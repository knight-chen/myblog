                        ...
                        <div width='1169px'>
                            <table width="1169px" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                                <tr>
                                    ...
                                    <th width="200px" height="20" bgcolor="d3eaef">留言时间</th>
                                    <th width="300px" height="20" bgcolor="d3eaef">留言内容</th>
                                    <th width="200px" height="20" bgcolor="d3eaef">管理操作</th>
                                </tr>
                                <?php if(is_array($messageList)): foreach($messageList as $k=>$v): ?><tr border="0" cellpadding="0" cellspacing="1" align="center" bgcolor="#FFFFFF">
                                        <td id='daily_type_id'><?php echo ($k+1); ?></td>
                                        <td><?php echo (date('Y-m-d',$v['creat_date'])); ?></td>
                                        <td><?php echo ($v['content']); ?></td>
                                        <td><a href="javascript:void(0);" onclick="delete_Message(<?php echo ($v['id']); ?>)" id='delete_daily'>删除</a></td>
...
//删除日志
    function delete_Message(messageId){
        var url="<?php echo U('Comment/delete_Message');?>";
        $.post(
        url,
        {
            messageId:messageId
