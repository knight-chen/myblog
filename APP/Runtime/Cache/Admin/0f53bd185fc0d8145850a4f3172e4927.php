                    ...
                    <td valign="top" style="margin-top: 0px;width: 1150px">
                        ...
                        <div width='1169px'>
                            <table width="1169px" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                                ...
                                <?php if(is_array($commentList)): foreach($commentList as $k=>$v): ?><tr border="0" cellpadding="0" cellspacing="1" align="center" bgcolor="#FFFFFF">
                                        <td id='daily_type_id'><?php echo ($k+1); ?></td>
                                        <td><?php echo (date('Y-m-d',$v['c_time'])); ?></td>
                                        <td><?php echo get_daily_type($v['dailyid'])?></td>
                                        <td><?php echo ($v['content']); ?></td>
                                        <td><a href="javascript:void(0);" onclick="delete_comment(<?php echo ($v['id']); ?>)" id='delete_daily'>删除</a></td>
