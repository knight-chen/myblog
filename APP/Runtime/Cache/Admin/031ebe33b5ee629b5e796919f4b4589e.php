...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="147" valign="top" style="margin-left: 0px"><script language="javascript">
	jQuery().ready(function(){
		jQuery('#navigation').accordion({
			header: '.head',
			navigation1: true, 
...
<div  style="height:500px;width: 147px;margin-left: 0;">
  <ul id="navigation">
    ...
    <td valign="top" style="margin-top: 0px;"><style type="text/css">
    .STYLE1 {
        color: #e1e2e3;
        font-size: 12px;
    }
            ...
            <td>
                <div>
                    ...
                    <form action="" method="post">
                        <ul>
                            <li><span>分类名称：</span><input type="text" name='info[type_name]' id="type_name"/><span id="name_error"></span></li>
                            <li><span>创建时间：</span><input type="text" name='info[c_time]' value="<?php echo ($time); ?>" id="c_time" readonly="true"/></li>
                            <li><span>分类描述：</span><textarea rows="4" cols="22" name="info[type_descript]" id="descript"></textarea></li>
                            <li><input type="button" value="添加" id="dosubmit" name="dosubmit"/></li>
                        </ul>
                    </form>
                </div> 
            </td>
