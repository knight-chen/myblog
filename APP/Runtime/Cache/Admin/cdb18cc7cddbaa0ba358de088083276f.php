                    ...
                    <td valign="top" style="margin-top: 0px;width: 1150px">
                        ...
                        <div width='1169px'>
                            <table width="1170px" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                                ...
                                <?php if(is_array($draftList)): foreach($draftList as $key=>$v): ?><tr border="0" cellpadding="0" cellspacing="1" align="center" bgcolor="#FFFFFF">
                                        <td id='draft_type_id'><?php echo ($v['id']); ?></td>
                                        <td><?php echo ($v['name']); ?></td>
                                        <td><?php echo (date('Y-m-d',$v['c_time'])); ?></td>
                                        <td><?php echo ($v['type']); ?></td>
                                        <td><?php echo ($v['author']); ?></td>
                                        <td><?php echo ($v['permission']); ?></td>
                                        <td><a href="<?php echo U('Daily/update_draft',array('draftId'=>$v['id']),'',0);?>">修改</a>|<a href="javascript:void(0);" onclick="delete_draft(<?php echo ($v['id']); ?>)" id='delete_draft'>删除</a>|<a href="<?php echo U('Daily/show_draft',array('draftId'=>$v['id']),'',0);?>">查看</a></td>
