...
<html>
    ...
    .center_right div  ul li {
        margin-top: 15px;
        list-style-type: none;
        font-size: 14px;
        font-weight:bolder;
    }
    .center_right div ul li span{
        font-size:14px;
        font-weight:bolder;
    }
    .center_right div  ul li {
    ...
    .center_right div ul li input {
        width: 300px;
        height:20px;
        margin-left: 10px;
    }
    .center_right div ul li textArea {
        width: 300px;
        height:80px;
        margin-left: 10px;
    }
                        ...
                        <td>
                            <div>
                                ...
                                <form action="" method="post">
                                    <ul>
                                        <li><span>分类名称：</span><input type="text" name='info[type_name]' id="type_name" value="<?php echo ($typeInfo['type_name']); ?>" /><span id="name_error"></span></li>
                                        <li><span>更新时间：</span><input type="text" name='info[c_time]' value="<?php echo ($c_time); ?>" id="c_time" readonly="true"/></li>
                                        <li><input type="hidden" name='info[id]' value="<?php echo ($typeInfo['id']); ?>" id='typeid'/></li>
                                        <li><span>分类描述：</span><textarea rows="4" cols="22" name="info[type_descript]" id="descript"><?php echo ($typeInfo['type_descript']); ?></textarea></li>
                                        <li><input type="button" value="取消" id="cancel" name="cancel" onclick="back('<?php echo U('Daily/daily_type_init','','',0);?>')"/><input type="button" value="确定" id="dosubmit" name="dosubmit"/></li>
                                        <script>
                                            var type_init_url="<?php echo U('Daily/daily_type_init','','',0);?>";
                                        </script>
                                    </ul>
                                </form>
                            </div> 
