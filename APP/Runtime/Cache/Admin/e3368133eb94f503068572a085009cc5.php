                    ...
                    <tr>
                        <td>
                            <div>
                                ...
                                <form action="<?php echo U('Daily/add_daily');?>" method="post" name="adddaily" id="adddaily">
                                    <input type="text" name="daily[name]" id="daily_name" placeholder="日志标题"/>
                                    ...
                                    <li style="none" id="li">
                                        ...
                                        <select name='daily[type]' id='daily_type'>
                                            <?php if(is_array($typeInfo)): foreach($typeInfo as $k=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo ($v['type_name']); ?></option><?php endforeach; endif; ?>
                                        </select>
                                        <span id='c_time' style=" margin-left: 100px !important; font-size: 14px;"><b>发布日期：</b></span><input type="text" style="height: 21px; " id="ctime" name="daily[c_time]" readonly="true" value="<?php echo date('Y-m-d',time());?>"/>
                                        ...
                                        <select style="width: 100;height: 25px;" name='daily[permission]' id='permission'>
                                            <?php if(is_array($permission)): foreach($permission as $key=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo ($v['permission']); ?></option><?php endforeach; endif; ?>
                                        </select>
                                        <span style='margin-left: 100px !important;font-size: 14px;'><b>原创作者：</b></span><input type='text' style="height: 21px; width: 160px; " id='author' name='daily[author]'/>
                                    </li>
                                    ...
                                    <li style=" margin-top: 6px;">
                                        <input type='submit' name='dosubmit' value='发布' style="width: 66px;height: 31px;background-color:rgb(173, 210, 218) " />
