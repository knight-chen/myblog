...
<div class="ibody">
  ...
  <article>
    <h2 class="about_h">您现在的位置是：<a href="/">首页</a>><a href="1/">图片分享</a>><a href="1/">个人相册</a></h2>
    <div class="template">
      <h3>
        <p><span>个人</span>相册</p>
        <a href="javascript:void(0);" class="more"></a> </h3>
      <ul>
        <?php if(is_array($albumList)): foreach($albumList as $k=>$v): ?><li><a href="<?php echo U('Index/photoList',array('id'=>$v['id']),'',0);?>"><?php if(empty($v["cover"])): ?><img src="/blog/APP/Home/View/Public/images/t00.jpg"><?php else: ?><img src="<?php echo ($v["cover"]); ?>"><?php endif; ?></a><span><?php echo ($v["name"]); ?></span></li><?php endforeach; endif; ?>
      </ul>
